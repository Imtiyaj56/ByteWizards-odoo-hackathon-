        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Building a sustainable fashion community through clothing exchange and conscious consumption.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Swap Requests</a></li>
            </ul>
          </div>
